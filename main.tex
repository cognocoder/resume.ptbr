    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Desenvolvimento Web}{Manutenção do portal Web departamental
          e outros assuntos tecnológicos em Java Server Pages, JavaScript,
          HTML, CSS e OpenCMS.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Programação \& Tecnologia}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Iniciante}{.NET, C\#, Java, MongoDB, Next.js, Node.js,
      OpenGL, Python, PyTest, React, SQL.}
  \resumeSubHeadingListEnd
